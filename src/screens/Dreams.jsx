// Dreams.jsx — Dream tracker with blur-to-clear photo reveal
...
export default function DreamsScreen({ palette, monthlySavings, onBack, onNext, className }) {
  const p = palette
    ...
    <div className={className} style={{
      ...
      <div style={{ padding: '4px 24px 0' }}>
        <div style={{
          ...
          {/* blurred 'photo' (CSS gradient placeholder) */}
          <div style={{
          ...
          {/* mono striped placeholder pattern overlay */}
          <div style={{
